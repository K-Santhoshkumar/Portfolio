...
export default function NotFound() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center py-20">
      <h1 className="text-3xl font-bold text-cyan-500 mb-4">Projects Not Found</h1>
      <p className="text-gray-300 mb-6">Sorry, we could&apos;t find any projects to display.</p>
